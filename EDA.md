...
![](EDA_files/figure-markdown_strict/unnamed-chunk-11-2.png)

    ggplot(crop_data, aes(y = Potassium)) +
      geom_boxplot(fill = "orange") +
      labs(title = "Boxplot of Potassium")

![](EDA_files/figure-markdown_strict/unnamed-chunk-11-3.png)

    ggplot(crop_data, aes(y = Temperature)) +
      geom_boxplot(fill = "orange") +
      labs(title = "Boxplot of Temperature")

![](EDA_files/figure-markdown_strict/unnamed-chunk-11-4.png)

    ggplot(crop_data, aes(y = Humidity)) +
      geom_boxplot(fill = "orange") +
      labs(title = "Boxplot of Humidity")

![](EDA_files/figure-markdown_strict/unnamed-chunk-11-5.png)

    ggplot(crop_data, aes(y = pH_Value)) +
      geom_boxplot(fill = "orange") +
      labs(title = "Boxplot of pH Value")

![](EDA_files/figure-markdown_strict/unnamed-chunk-11-6.png)

    ggplot(crop_data, aes(y = Rainfall)) +
      geom_boxplot(fill = "orange") +
      labs(title = "Boxplot of Rainfall")

![](EDA_files/figure-markdown_strict/unnamed-chunk-11-7.png)
...
![](EDA_files/figure-markdown_strict/unnamed-chunk-14-2.png)
...
![](EDA_files/figure-markdown_strict/unnamed-chunk-14-3.png)
